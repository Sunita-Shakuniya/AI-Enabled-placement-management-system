...
import searchIcon from '../../admin/elements/search_icon.png';
import downloadIcon from '../../admin/elements/download_icon.png';
import { fetchStudents } from '../../../services/student.service';
function RecruitersStudentData() {
                  ...
                  <table className="min-w-full bg-white rounded-lg shadow-md overflow-hidden">
                    <thead>
                      ...
                      <th className="px-6 py-3 text-left text-sm font-semibold cursor-pointer" onClick={() => handleSort('student_id')}>Student ID</th>
                        ...
                        <th className="px-6 py-3 text-left text-sm font-semibold cursor-pointer" onClick={() => handleSort('email')}>Resume</th>
                        <th className="px-6 py-3 text-left text-sm font-semibold cursor-pointer" onClick={() => handleSort('phone')}>LinkedIn</th>
                        <th className="px-6 py-3 text-left text-sm font-semibold cursor-pointer" onClick={() => handleSort('phone')}>Github</th>
                        ...
                        <th className="px-6 py-3 text-left text-sm font-semibold">Like/Shortlist</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      {currentItems.map((student) => (
                        <tr key={student.student_id} className="hover:bg-gray-50 transition-colors" >
                          ...
                          <td className="px-6 py-2"><p className="text-sm text-gray-600"></p> <a href={student.resume_link} className="text-blue-600 hover:underline" >Link</a></td>
                          <td className="px-6 py-2"><p className="text-sm text-gray-600"></p> <a href= {student.linkedin_link} className="text-blue-600 hover:underline" >
                          ...
                          <td className="px-6 py-2"><h6 className="text-sm text-gray-600"></h6><a href= {student.github_link} className="text-blue-600 hover:underline" >
                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
                          ...
                          <td className="flex px-6 py-2 gap-x-2">
                            ...
                            ><span className='font-bold pr-2'> + </span> add
                            </button>
...
export default RecruitersStudentData